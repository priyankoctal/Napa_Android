...
//    }
    ...
    public static void writeToFile(@NonNull InputStream in, @NonNull File file) {
        try {
    ...
    @NonNull
    public static File pickedExistingPicture(@NonNull Context context, @NonNull Uri photoUri) throws IOException {
