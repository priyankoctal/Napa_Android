package com.octalsoftaware.archi.lib.swipe.implments;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;
import android.view.View;

import com.octalsoftaware.archi.lib.swipe.SimpleSwipeListener;
...
public class SwipeItemMangerImpl implements SwipeItemMangerInterface {
    ...
    public SwipeItemMangerImpl(@Nullable SwipeAdapterInterface swipeAdapterInterface) {
    ...
    public void bind(@NonNull View view, int position) {
    ...
    class OnLayoutListener implements SwipeLayout.OnLayout {
        ...
        @Override
        public void onLayout(@NonNull SwipeLayout v) {
            if (isOpen(position)) {
                v.open(false, false);
            } else {
                v.close(false, false);
