...
import com.octalsoftaware.archi.databinding.PatientSafetyBinding;
...
public class PatientSafety extends BaseActivity implements View.OnClickListener {

    @Nullable
    private PatientSafetyBinding mBinding = null;
    @Nullable
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.patient_safety);

        patient_id = getIntent().getStringExtra(S.patient_details);
        database = new Database(context);

        // set Title
        mBinding.mainToolbar.toolbarheading.setText(getString(R.string.patient_safety));
