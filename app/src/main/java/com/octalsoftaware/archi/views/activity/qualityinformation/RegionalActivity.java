...
import com.octalsoftaware.archi.databinding.RegionalBinding;
...
public class RegionalActivity extends BaseActivity implements View.OnClickListener {
    ...
    @Nullable
    private RegionalBinding mBinding = null;
    @Nullable
    private Context context = null;
    @Nullable
    private MyProgressDialog progressDialog = null;
    public static String TAG = RegionalActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.regional);
        ...
        // set Title
        mBinding.mainToolbar.toolbarheading.setText(getString(R.string.regional));
    ...
    public void onBackPressed() {
        if (Util.isNetworkConnected(context)) {
            try {
                ...
                if (mBinding.checkboxLeft1.isChecked())
                    jsonObject.put(getString(R.string.wet_tap), getString(R.string.intra_op));
                else if (mBinding.checkboxRight1.isChecked())
                    jsonObject.put(getString(R.string.wet_tap), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.wet_tap), getString(R.string.no));

                if (mBinding.checkboxLeft2.isChecked())
                    jsonObject.put(getString(R.string.post_dural_puncture), getString(R.string.intra_op));
                else if (mBinding.checkboxRight2.isChecked())
                    jsonObject.put(getString(R.string.post_dural_puncture), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.post_dural_puncture), getString(R.string.no));

                if (mBinding.checkboxLeft3.isChecked())
                    jsonObject.put(getString(R.string.failed_regional_block), getString(R.string.intra_op));
                else if (mBinding.checkboxRight3.isChecked())
                    jsonObject.put(getString(R.string.failed_regional_block), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.failed_regional_block), getString(R.string.no));

                if (mBinding.checkboxLeft4.isChecked())
                    jsonObject.put(getString(R.string.local_anesthetic_toxicity), getString(R.string.intra_op));
                else if (mBinding.checkboxRight4.isChecked())
                    jsonObject.put(getString(R.string.local_anesthetic_toxicity), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.local_anesthetic_toxicity), getString(R.string.no));

                if (mBinding.checkboxLeft5.isChecked())
                    jsonObject.put(getString(R.string.excessive_block_requiring_airway_support), getString(R.string.intra_op));
                else if (mBinding.checkboxRight5.isChecked())
                    jsonObject.put(getString(R.string.excessive_block_requiring_airway_support), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.excessive_block_requiring_airway_support), getString(R.string.no));

                if (mBinding.checkboxLeft6.isChecked())
                    jsonObject.put(getString(R.string.epidural_hematoma_following_regional), getString(R.string.intra_op));
                else if (mBinding.checkboxRight6.isChecked())
                    jsonObject.put(getString(R.string.epidural_hematoma_following_regional), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.epidural_hematoma_following_regional), getString(R.string.no));

                if (mBinding.checkboxLeft7.isChecked())
                    jsonObject.put(getString(R.string.epidural_abscess_following_regional), getString(R.string.intra_op));
                else if (mBinding.checkboxRight7.isChecked())
                    jsonObject.put(getString(R.string.epidural_abscess_following_regional), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.epidural_abscess_following_regional), getString(R.string.no));

                if (mBinding.checkboxLeft8.isChecked())
                    jsonObject.put(getString(R.string.peripheral_nerve_injury_in_distribution_of_regional_anesthesia), getString(R.string.intra_op));
                else if (mBinding.checkboxRight8.isChecked())
                    jsonObject.put(getString(R.string.peripheral_nerve_injury_in_distribution_of_regional_anesthesia), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.peripheral_nerve_injury_in_distribution_of_regional_anesthesia), getString(R.string.no));
       /* if(mBinding.checkboxLeft9.isChecked())
            jsonObject.put(getString(R.string.infection_after_a_peripheral_nerve_block), getString(R.string.intra_op));*/
                if (mBinding.checkboxRight9.isChecked())
                    jsonObject.put(getString(R.string.infection_after_a_peripheral_nerve_block), getString(R.string.post_op));
                else
                    jsonObject.put(getString(R.string.infection_after_a_peripheral_nerve_block), getString(R.string.no));
    ...
    private void fillQIDetails(@NonNull CustomArrayList<AdvancedQIModal> save_qi) {
        if (save_qi.contains(getString(R.string.wet_tap).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.wet_tap).toLowerCase());
        ...
        if (save_qi.contains(getString(R.string.post_dural_puncture).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.post_dural_puncture).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
                mBinding.checkboxLeft2.setChecked(true);
            else if ((save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.post_op))))
                mBinding.checkboxRight2.setChecked(true);
        }
        if (save_qi.contains(getString(R.string.failed_regional_block).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.failed_regional_block).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
                mBinding.checkboxLeft3.setChecked(true);
            else if ((save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.post_op))))
                mBinding.checkboxRight3.setChecked(true);
        }
        if (save_qi.contains(getString(R.string.local_anesthetic_toxicity).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.local_anesthetic_toxicity).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
                mBinding.checkboxLeft4.setChecked(true);
            else if ((save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.post_op))))
                mBinding.checkboxRight4.setChecked(true);
        }
        if (save_qi.contains(getString(R.string.excessive_block_requiring_airway_support).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.excessive_block_requiring_airway_support).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
                mBinding.checkboxLeft5.setChecked(true);
            else if ((save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.post_op))))
                mBinding.checkboxRight5.setChecked(true);
        }
        if (save_qi.contains(getString(R.string.epidural_hematoma_following_regional).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.epidural_hematoma_following_regional).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
                mBinding.checkboxLeft6.setChecked(true);
            else if ((save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.post_op))))
                mBinding.checkboxRight6.setChecked(true);
        }
        if (save_qi.contains(getString(R.string.epidural_abscess_following_regional).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.epidural_abscess_following_regional).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
                mBinding.checkboxLeft7.setChecked(true);
            else if ((save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.post_op))))
                mBinding.checkboxRight7.setChecked(true);
        }
        if (save_qi.contains(getString(R.string.peripheral_nerve_injury_in_distribution_of_regional_anesthesia).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.peripheral_nerve_injury_in_distribution_of_regional_anesthesia).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
                mBinding.checkboxLeft8.setChecked(true);
            else if ((save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.post_op))))
                mBinding.checkboxRight8.setChecked(true);
        }
        if (save_qi.contains(getString(R.string.infection_after_a_peripheral_nerve_block).toLowerCase())) {
            int pos = save_qi.indexOf(getString(R.string.infection_after_a_peripheral_nerve_block).toLowerCase());
            if (save_qi.get(pos).getId().equalsIgnoreCase(getString(R.string.intra_op)))
